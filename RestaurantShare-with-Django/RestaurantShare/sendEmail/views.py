...
def sendEmail(request):
    ...
    for checked_res_in checked_res_list:
        ...
        mail_html += "<h4>* 관련 키워드</h4>"+"<p>"+restaurant.restaurant_ketword+"</p><br>"
        mail_html += "<br>"
    mail_html +="</body></html>"

    server = smtplib.SMTP_SSL('smtp.gmail.com', 465)
    server.login("happygood1212@gmail.com","CLARA3322!")
